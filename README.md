...
mkdir build
cd build
cmake .. -DCMAKE_PREFIX_PATH:PATH=D:\Work\3rd\install\Windows\x86_64\Debug -DCMAKE_INSTALL_PREFIX:PATH=D:\Work\3rd\install\Windows\x86_64\Debug -DYLT_ENABLE_SSL:BOOL=ON -DBUILD_EXAMPLES:BOOL=OFF -DBUILD_BENCHMARK:BOOL=OFF -DBUILD_UNIT_TESTS:BOOL=OFF
